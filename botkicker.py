...
import time,random,sys,re,os,json,subprocess,codecs,pytz,threading,glob

me = PRANKBOTS.LINE() 
me.login(token="EzQAL4pZvwPl4oKqGcu4.mqKc2MNKlpicxDXNF/VJPa.1OAVhQtCNwFlTAvDk+oUi3UkMmBe+MJQmoFrxJgUjxI=")
me.loginResult()
